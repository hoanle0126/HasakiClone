          ...
          >
              ...
              >
                ...
                <Stack>
                  ...
                  <Stack direction="row" alignItems="center" gap="8px">
                    ...
                    >
                      <Typography variant="captiontext">0 đánh giá</Typography>
                      <Typography variant="captiontext">0 đánh giá</Typography>
            ...
            >
              <Stack direction="row" gap="36px">
                {[
                  { title: "Mô tả", id: "mo-ta" },
                  { title: "Thông số", id: "thong-so" },
                  { title: "Thành phần", id: "thanh-phan" },
                  { title: "Cách dùng", id: "cach-dung" },
                  { title: "Đánh giá", id: "danh-gia" },
                  { title: "Hỏi đáp", id: "hoi-dap" },
                ].map((item, index) => (
